...
/**
 * 默认Exception Handler，优先级Order=100，Response=泛型的模式
 * <p>
 * logback异常优化
 ...
 * @author Ricardo.Y.Hu
 * @version : V1.0
 * @date 2023/6/21 17:29
 */
@Slf4j
@Order(100)
@RestControllerAdvice
public final class GenericResponseHttpStatusExceptionHandler {
    ...
    private static final String TOO_MANY_REQUESTS_LOG = "429:******Too Many Requests*******";
    ...
    public GenericResponseEntity<String> handleVerifyException(MaxUploadSizeExceededException ex, HttpServletRequest request) {
    ...
    public final GenericResponseEntity<String> handleUnauthorizedException(UnAuthorizedException ex, HttpServletRequest request) {
        return generalExceptionHandler(
                "",
                ex,
                request,
